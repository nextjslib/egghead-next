...
function CollectionSeoComponent(props: {
  description: any
  path: any
  title: any
  instructor: any
  ...
  return (
    <NextSeo
      description={removeMarkdown(props.description)}
      canonical={`${process.env.NEXT_PUBLIC_DEPLOYMENT_URL}${props.path}`}
      title={props.title}
      titleTemplate={'%s | egghead.io'}
      twitter={{
        handle: props.instructor?.twitter ?? `@eggheadio`,
        site: `@eggheadio`,
        cardType: 'summary_large_image',
      }}
      openGraph={{
        title: props.title,
        url: `${process.env.NEXT_PUBLIC_DEPLOYMENT_URL}${props.path}`,
        description: removeMarkdown(props.description),
        site_name: 'egghead',
        images: [
          {
...
const SpecialCollectionLayout: React.FunctionComponent<CoursePageLayoutProps> = ({
  lessons,
  course,
  ogImageUrl,
}) => {
...
export default SpecialCollectionLayout
